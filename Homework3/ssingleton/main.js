...
//NEW HERE -> Learning to move

// Handle click to expand pie chart
d3.select("#type-pie-chart").on("click", () => {
  document.getElementById("pie-wrapper").classList.add("fullscreen");
  updatePieChart(); // Re-render to fit larger space
});

// Handle click to collapse back
document.getElementById("pie-back-button").addEventListener("click", () => {
  document.getElementById("pie-wrapper").classList.remove("fullscreen");
  updatePieChart(); // Re-render to fit normal space
});